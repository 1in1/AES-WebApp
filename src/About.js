...
function AboutPage(props) {
    return (
        <div className='page'>
            ...
            <p>The <a href='https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.197.pdf' target='_blank' rel='noopener noreferrer' >FIPS specification</a> has been my information source, and invaluable for writing this.</p>
        </div>
    );
}
